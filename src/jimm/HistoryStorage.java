...
class HistoryStorageList extends VirtualList
    ...
    private static final Command cmdMsgBack = new Command(ResourceBundle.getString("back"), Command.BACK, 1);
    private static final Command cmdMsgNext = new Command(ResourceBundle.getString("next"), Command.ITEM, 2);
    private static final Command cmdMsgPrev = new Command(ResourceBundle.getString("prev"), Command.ITEM, 3);
    private static final Command cmdMsgCopyText = new Command(ResourceBundle.getString("copy_text"), Command.ITEM, 4);

    // commands for messages list
    private static final Command cmdClrAll = new Command(ResourceBundle.getString("clear_all"), Command.SCREEN, 10);
    private static final Command cmdSelect = new Command(ResourceBundle.getString("select"), Command.OK, 1);
    private static final Command cmdBack = new Command(ResourceBundle.getString("back"), Command.BACK, 2);
    private static final Command cmdClear = new Command(ResourceBundle.getString("clear"), Command.ITEM, 4);
    private static final Command cmdFind = new Command(ResourceBundle.getString("find"), Command.ITEM, 3);
    private static final Command cmdInfo = new Command(ResourceBundle.getString("history_info"), Command.ITEM, 6);
    private static final Command cmdCopyText = new Command(ResourceBundle.getString("copy_text"), Command.ITEM, 5);
