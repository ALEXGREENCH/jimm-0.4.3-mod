 ...
 ********************************************************************************
 ...
 Based on CVS 1.82 Text_EN (2005.11.07 09:00)
...
public class Text_LT extends ResourceBundle {
    ...
    public Text_LT() {
        ...
        resources.put("home_page", "Svetainė");
        resources.put("home_info", "Namų inf.");
        ...
        resources.put("interests", "Domisi");
        resources.put("invisible_check", "Nematomas?");
        ...
        resources.put("latest_ver", "Naujausia versija");
        resources.put("loading", "Kraunasi");
        resources.put("main_info", "Apie vartotoją");
        ...
        resources.put("position", "Pozicija");
        ...
        resources.put("text_too_long", "Per ilgas tekstas įterpimui");
        resources.put("timeout_interv", "Keepalive packet interval");
        resources.put("title", "Kreipinys");
        ...
        resources.put("work_info", "Darbo inf.");
        ...
        resources.put("error_172", "Klaida saugant nustatymus (#172.EXT)");
